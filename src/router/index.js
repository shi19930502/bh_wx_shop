...
export default new Router({
	routes: [{
		...
		path: '/showShopProduct',
		name: 'showShopProduct',
		component: resolve => require(['../views/northviews/showShopProduct.vue'], resolve),
	}, { //北环个人客户门店列表页面
		path: '/NorthDoorStore',
		name: 'NorthDoorStore',
		...
		component: resolve => require(['../views/northviews/CompleteRegInfo.vue'], resolve),
	}, {
		path: '/Login',
		name: 'Login',
		...
		path: '/suyuan',
		name: 'suyuan',
		component: resolve => require(['../views/order/qr_zs.vue'], resolve)
	}]
})
