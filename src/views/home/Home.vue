  ...
  <div id="Home">
    <yd-scrolltab ref="productList">
      <div class="scrolltab-content" style="height: 100%;overflow-y: auto;">
        <div class="header gradient" style="padding: 0">
          <!-- <div class="search">
          ...
          <yd-flexbox direction="vertical">
            <yd-flexbox-item>
              <!-- <div id="main"></div> -->
              <div id="main1" style=" font-size: 0"><img src="../../assets/imgs/northring/home_babner.png" alt="" width="100%"></div>
            </yd-flexbox-item>
                ...
                <div class="flex-item-5">
                  <yd-rollnotice autoplay="5000" height="40">
                    <template v-if="msgdataList.length>0">
                      <yd-rollnotice-item v-for="d in msgdataList" :key="d.id">{{d.comment.length>23?d.comment.substring(0,23)+'...':d.comment}}</yd-rollnotice-item>
                    </template>
                    <template v-else>
        ...
        <!-- 最新采购 -->
        <div class="zxcg">
          <info-card title="最新采购" moreBtnText="查看全部采购" @click="toAllPurchase" :showmoreBtn="newestOrder.sellerName?true:false">
                  ...
                  <div class="flex">
                    <template v-for="orderitem,key in newestOrder.orderitemList">
                      <div class="product-img" v-if="key<4">
                        ...
                        <img v-else-if="orderitem.productPicUrl" :src="imgURL+orderitem.productPicUrl" alt="">
