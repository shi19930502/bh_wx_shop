          ...
          <div class="search flex flex-y-center">
            <div class="select-pfs flex-item-4 flex flex-y-center">
              ...
              <div style="margin-left:0.1rem;">
                <!-- <yd-badge shape="square" bgcolor="#FE971D" @click.native="toShow1pStores">批发商店铺</yd-badge> -->
                <!-- <yd-badge v-if="userInfo.userType=='003'" shape="square" bgcolor="#FE971D" @click.native="toShow1pStores">配送公司</yd-badge> -->
              </div>
            </div>
            <div>
