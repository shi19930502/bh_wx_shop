            ...
            <span style="color:#4D7BFE;margin-left: 0.1rem;">联系</span>
						...
						<li v-for="d in orderDetail.orderitemList">
							<div class="flex flex-x-between flex-y-center">
								...
								<div class="tar" v-else>
									...
									<p><strong>{{'￥'+d.itemTotal/100}}</strong></p>
								</div>
              ...
              <a href="tel:18011905688">联系商家</a>
						...
						<div>
							...
							<!--实际验收小计-->
							<strong style="font-size: 0.36rem;" v-show="orderDetail.inspectedOrderTotal>0">{{'￥'+orderDetail.inspectedOrderTotal/100}}</strong>
							<!--实际分拣小计-->
							<strong style="font-size: 0.36rem;" v-show="orderDetail.sortingOrderTotal>0 && orderDetail.inspectedOrderTotal==0">{{'￥'+orderDetail.sortingOrderTotal/100}}</strong>
							<strong style="font-size: 0.36rem;" v-if="orderDetail.sortingOrderTotal ==null && orderDetail.inspectedOrderTotal ==null">{{'￥'+orderDetail.orderTotal/100}}</strong>
							<div class="line-through tar" v-else>{{'￥'+orderDetail.orderTotal/100}}</div>
						</div>
						<!--<div>
            <span>验收合计</span>
