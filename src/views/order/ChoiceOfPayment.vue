...
export default {
  ...
  async created() {
    ...
    if (this.$route.params.payParams) {
      ...
      this.payParams.wuliutype == 1 ? (this.showTime = true) : (this.showTime = false)
    ...
    toOrderCheckoutSuccess() {
      ...
      this.$router.push({
        ...
        query: {
          ...
          sellerName: this.$route.params.shopCarParam.sellerName,
          distributionType: this.$route.params.shopCarParam.distributionType
        }
      });
    },
    /**
